[![codecov](https://codecov.io/gh/LizaAvsyannik/MADE_Cpp_2022/branch/main/graph/badge.svg?token=NX85UGLETP)](https://codecov.io/gh/LizaAvsyannik/MADE_Cpp_2022/tree/hw1)
### _To run programm_
```
cmake . -B build
cmake --build build
