...
TEST(DATA, Copy) {
  ...
  EXPECT_EQ(test_info.installation_date.day,
            test_info_copy.installation_date.day);
  EXPECT_EQ(test_info.installation_date.month,
            test_info_copy.installation_date.month);
  EXPECT_EQ(test_info.installation_date.year,
            test_info_copy.installation_date.year);
  EXPECT_EQ(test_info.last_update_date.day,
            test_info_copy.last_update_date.day);
  EXPECT_EQ(test_info.last_update_date.month,
            test_info_copy.last_update_date.month);
  EXPECT_EQ(test_info.last_update_date.year,
            test_info_copy.last_update_date.year);
